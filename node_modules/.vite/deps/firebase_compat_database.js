...
} from "./chunk-VTR6GTHJ.js";
import {
  firebase
} from "./chunk-EMFTWBIY.js";
import {
  Component,
  ComponentContainer,
  Deferred,
...
var Query = class {
  ...
  startAt(value = null, name2) {
    ...
    return new Query(this.database, query(this._delegate, startAt(value, name2)));
  }
  startAfter(value = null, name2) {
    validateArgCount("Query.startAfter", 0, 2, arguments.length);
    return new Query(this.database, query(this._delegate, startAfter(value, name2)));
  }
  endAt(value = null, name2) {
    validateArgCount("Query.endAt", 0, 2, arguments.length);
    return new Query(this.database, query(this._delegate, endAt(value, name2)));
  }
  endBefore(value = null, name2) {
    validateArgCount("Query.endBefore", 0, 2, arguments.length);
    return new Query(this.database, query(this._delegate, endBefore(value, name2)));
  }
  equalTo(value, name2) {
    validateArgCount("Query.equalTo", 1, 2, arguments.length);
    return new Query(this.database, query(this._delegate, equalTo(value, name2)));
  }
  toString() {
...
function initStandalone({ app, url, version: version2, customAuthImpl, namespace, nodeAdmin = false }) {
